...
void *func_80011E78(void *arg0) {
    ...
    if (temp_s3 != 0) {
        ...
        phi_s3 = temp_s3;
loop_2:
        if (func_80012170(phi_s0->unk62) == 0) {
...
block_7:
            ...
            if (phi_f0 < temp_f26) {
                if (temp_f28 < phi_f0) {
                    temp_f20 = arg0->unk0 - phi_s0->unk44;
                    temp_f22 = arg0->unk8 - phi_s0->unk4C;
                    if (((temp_f20 * temp_f20) + (temp_f22 * temp_f22)) < 300.0f) {
                        (void *)0x800869A8->unk0 = temp_f20;
                        (void *)0x800869A8->unk4 = temp_f22;
                        func_800232F4(phi_s0->unk1C, (void *)0x800869A8);
                        ...
                        if (phi_f20 < phi_s0->unk18) {
                            phi_s3_2 = phi_s3;
                            phi_s0_2 = phi_s0;
                            if (!(phi_f22 < phi_s0->unk20)) {
block_17:
                                temp_s3_2 = phi_s3 - 1;
                                temp_s0 = phi_s0 + 0x6C;
                                phi_s0 = temp_s0;
