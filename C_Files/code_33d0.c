...
loop_2:
        ...
        if (temp_v0->unk74 != -1) {
            ...
            if ((f64) func_80034F60((temp_f20 * temp_f20) + (temp_f22 * temp_f22)) < ((f64) (temp_f30 + temp_f24) + 10.0)) {
                ...
                if (temp_v1 == 1) {
                    ...
                    phi_f22 = (f32) (2.0 * (f64) temp_v0_2->unk18);
                } else if (temp_v1 == 2) {
                    phi_f20 = 0.0f;
                    phi_f22 = 0.0f;
                } else {
                ...
                if ((phi_f20_2 - ((phi_f22 * temp_s0->unk24) + (arg0->unk64->unk1C * arg0->unk24))) <= 0.0f) {
                    func_800232F4(arg0->unk10, (void *)0x8007BC30);
                    if ((void *)0x8007BC30->unk4 >= 0.0f) {
                        temp_f0 = (void *)0x8007BC30->unk0;
                        if (-temp_f24 < temp_f0) {
                            if (temp_f0 < temp_f24) {
                                sp70 = *phi_s3 + 1;
                            } else {
