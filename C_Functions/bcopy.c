s32 bcopy(s32 src, s32 dst, s32 length) {
    s16 temp_v0_3;
    s16 temp_v1;
    s32 temp_a0;
    s32 temp_a1;
...
loop_9:
        ...
        if (temp_v0_5 != 0) {
            if (temp_v0_5 != 1) {
                if (temp_v0_5 != 2) {
                    temp_a1_5 = dst + 1;
                    temp_a1_5->unk-1 = (s8) src->unk0;
                    phi_a2_5 = length - 1;
                    phi_a0_6 = src + 1;
                    phi_a1_5 = temp_a1_5;
                } else {
                    temp_a1_6 = dst + 2;
                    temp_a1_6->unk-2 = (s16) src->unk0;
                    phi_a2_5 = length - 2;
                    phi_a0_6 = src + 2;
                    phi_a1_5 = temp_a1_6;
                }
                ...
                temp_a1_7 = dst + 3;
                temp_a1_7->unk-3 = (s8) src->unk0;
                temp_a1_7->unk-2 = (s16) src->unk1;
                phi_a2_5 = length - 3;
                phi_a0_6 = src + 3;
                phi_a1_5 = temp_a1_7;
            }
...
loop_21:
    ...
    if (dst >= ERROR(unknown instruction: add $v0, $a0, $a2)) {
        goto block_5;
    }
    ...
    if ((length < 0x10) || (temp_v0 = temp_a0 & 3, phi_a2_4 = length, phi_a0_5 = (void *) temp_a0, phi_a1_9 = (void *) temp_a1, (temp_v0 != (temp_a1 & 3)))) {
