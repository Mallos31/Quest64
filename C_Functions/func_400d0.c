...
loop_3:
    ...
    if (phi_s0 != 0) {
        spD0 = 0;
        temp_v0_5 = func_0003FB74(0x80071F24, *temp_s2_3);
        phi_s0_2 = temp_v0_5;
        phi_s2_3 = temp_s2_3;
        phi_s2_4 = temp_s2_3;
        if (temp_v0_5 != 0) {
loop_12:
            ...
            temp_v0_6 = func_0003FB74(0x80071F24, *temp_s2_4);
            phi_s0_2 = temp_v0_6;
            phi_s2_3 = temp_s2_4;
            phi_s2_4 = temp_s2_4;
            if (temp_v0_6 != 0) {
...
loop_30:
        ...
        if (func_0003FB74(0x80071F20, phi_a1_4) != 0) {
            spD4 = *phi_s2_8;
            phi_s2_9 = phi_s2_8 + 1;
        } else {
            spD4 = (u8)0U;
        ...
        func_0003EE60(*phi_s2_10, &arg3, &sp74);
