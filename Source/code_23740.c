void *func_80022B40(void *arg0, void *arg1, s32 arg2) {
    void *spD8;
    f32 spD0;
    f32 spCC;
    f32 spC8;
...
loop_5:
    ...
    if (phi_a0_2->unk30 == 0) {
        ...
        spD8 = phi_a0_2;
        sp94 = temp_t3;
        func_80022F60((f32) temp_s1 / temp_f0, phi_a0_2, &spD0, &spCC, &spC8, &spC4);
        temp_a0_3 = phi_a0_2;
...
f32 func_80022F60(f32 arg0, void *arg1, void *arg2, void *arg3, void *arg4) {
    f32 temp_f0;
    f32 temp_f16;
    f32 temp_f18;
    f32 temp_f2;
