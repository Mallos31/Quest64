...
s32 func_8000F238(f32 arg0, f32 arg1, f32 arg2, s32 arg3, void *arg4, void *arg5) {
    s32 sp88;
    f32 sp74;
    f32 sp70;
    f32 temp_f0;
...
block_17:
                                        arg1 = phi_f14;
                                        temp_s0 = func_8000F5A4(arg0, phi_f14, temp_a0, temp_a1, (bitwise s32) sp74, (bitwise s32) sp70, temp_f20, temp_f22);
                                        temp_s0_2 = temp_s0 + func_8000F5A4(arg0, arg1, temp_f20, temp_f22, temp_f24, temp_f26);
                                        phi_s0 = temp_s0_2 + func_8000F5A4(arg0, arg1, (bitwise s32) sp74, (bitwise s32) sp70, temp_f24, temp_f26);
                                        phi_f14_2 = arg1;
                                    }
                                } else {
                                    goto block_17;
        ...
        if (func_8000FFE8(phi_s0) != 0) {
            ...
            if (phi_f0 < phi_s0->unkC) {
                if (phi_f2 < phi_s0->unk10) {
                    if ((phi_s0->unk14 & 2) == 0) {
                        if (func_8000FF54(arg2 - phi_s0->unk8) != 0) {
block_14:
                            func_80010080(phi_s0);
                            sp40 = 1;
                        }
                    } else {
                        goto block_14;
