...
/* 1BDF8 8001B1F8 3C128008 */  lui        $s2, %hi(UNK_DisplayListCommand)
/* 1BDFC 8001B1FC 4481B000 */  mtc1       $at, $f22
/* 1BE00 8001B200 4480A000 */  mtc1       $zero, $f20
/* 1BE04 8001B204 2652B2FC */  addiu      $s2, $s2, %lo(UNK_DisplayListCommand)
...
/* 1C10C 8001B50C 3C048008 */  lui        $a0, %hi(UNK_DisplayListCommand)
/* 1C110 8001B510 2484B2FC */  addiu      $a0, $a0, %lo(UNK_DisplayListCommand)
...
/* 1C30C 8001B70C 3C048008 */  lui        $a0, %hi(UNK_DisplayListCommand)
/* 1C310 8001B710 2484B2FC */  addiu      $a0, $a0, %lo(UNK_DisplayListCommand)
...
/* 1C510 8001B910 3C048008 */  lui        $a0, %hi(UNK_DisplayListCommand)
/* 1C514 8001B914 2484B2FC */  addiu      $a0, $a0, %lo(UNK_DisplayListCommand)
...
/* 1C71C 8001BB1C 3C048008 */  lui        $a0, %hi(UNK_DisplayListCommand)
/* 1C720 8001BB20 2484B2FC */  addiu      $a0, $a0, %lo(UNK_DisplayListCommand)
...
/* 1C928 8001BD28 3C048008 */  lui        $a0, %hi(UNK_DisplayListCommand)
/* 1C92C 8001BD2C 2484B2FC */  addiu      $a0, $a0, %lo(UNK_DisplayListCommand)
...
/* 1CB2C 8001BF2C 3C048008 */  lui        $a0, %hi(UNK_DisplayListCommand)
/* 1CB30 8001BF30 2484B2FC */  addiu      $a0, $a0, %lo(UNK_DisplayListCommand)
...
/* 1CD30 8001C130 3C048008 */  lui        $a0, %hi(UNK_DisplayListCommand)
/* 1CD34 8001C134 2484B2FC */  addiu      $a0, $a0, %lo(UNK_DisplayListCommand)
...
/* 1CF38 8001C338 3C048008 */  lui        $a0, %hi(UNK_DisplayListCommand)
/* 1CF3C 8001C33C 2484B2FC */  addiu      $a0, $a0, %lo(UNK_DisplayListCommand)
