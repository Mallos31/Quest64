...
/* 1D198 8001C598 3C028008 */  lui        $v0, %hi(unk_copiedToMapFlags)
/* 1D19C 8001C59C 8C424F18 */  lw         $v0, %lo(unk_copiedToMapFlags)($v0)
...
/* 1D290 8001C690 0C008BF4 */  jal        ReturnRandomNumber
...
/* 1D3E4 8001C7E4 3C018009 */   lui       $at, %hi(tempEnemyNumMin1)
/* 1D3E8 8001C7E8 A420C598 */  sh         $zero, %lo(tempEnemyNumMin1)($at)
...
/* 1D404 8001C804 3C018009 */  lui        $at, %hi(tempEnemyNumMin1)
/* 1D408 8001C808 2728FFFF */  addiu      $t0, $t9, -1
/* 1D40C 8001C80C A428C598 */  sh         $t0, %lo(tempEnemyNumMin1)($at)
.L8001C810:
/* 1D410 8001C810 0C000E87 */  jal        UNK_Battle_Init
/* 1D414 8001C814 00000000 */   nop
/* 1D418 8001C818 0C008222 */  jal        VOID_FUN_80020888
...
/* 1D490 8001C890 0C008BF4 */  jal        ReturnRandomNumber
...
/* 1D5C8 8001C9C8 0C002498 */  jal        VOID_FUN_80009260
...
/* 1D614 8001CA14 3C018009 */  lui        $at, %hi(tempEnemyNumMin1)
/* 1D618 8001CA18 25CFFFFF */  addiu      $t7, $t6, -1
/* 1D61C 8001CA1C A42FC598 */  sh         $t7, %lo(tempEnemyNumMin1)($at)
...
/* 1D64C 8001CA4C 0C008222 */  jal        VOID_FUN_80020888
...
/* 1D74C 8001CB4C 0C008BF4 */  jal        ReturnRandomNumber
...
/* 1DC2C 8001D02C 3C198009 */   lui       $t9, %hi(tempEnemyNumMin1)
/* 1DC30 8001D030 9739C598 */  lhu        $t9, %lo(tempEnemyNumMin1)($t9)
...
/* 1DD0C 8001D10C 0C00760A */  jal        itemDropSomething
...
/* 1DD90 8001D190 0C0023DB */  jal        VOID_EscapeBattle(CONFIRM)
/* 1DD94 8001D194 00000000 */   nop
/* 1DD98 8001D198 3C048008 */  lui        $a0, %hi(cameraZoomMode)
/* 1DD9C 8001D19C 0C0050F0 */  jal        VOID_FUN_800143c0
...
/* 1DDE0 8001D1E0 0C009A13 */  jal        updateBGMOnMapTransition
...
/* 1DE10 8001D210 0C0024CB */  jal        VOID_FUN_8000932c
...
/* 1DE50 8001D250 3C0D8009 */  lui        $t5, %hi(tempEnemyNumMin1)
/* 1DE54 8001D254 95ADC598 */  lhu        $t5, %lo(tempEnemyNumMin1)($t5)
...
/* 1DE9C 8001D29C 3C198009 */  lui        $t9, %hi(tempEnemyNumMin1)
/* 1DEA0 8001D2A0 9739C598 */  lhu        $t9, %lo(tempEnemyNumMin1)($t9)
...
/* 1DFA8 8001D3A8 3C058009 */  lui        $a1, %hi(tempEnemyNumMin1)
/* 1DFAC 8001D3AC 24A5C598 */  addiu      $a1, $a1, %lo(tempEnemyNumMin1)
...
.L8001D60C:
/* 1E20C 8001D60C 0C008BF4 */  jal        ReturnRandomNumber
...
/* 1E28C 8001D68C 0C008BF4 */  jal        ReturnRandomNumber
...
/* 1E310 8001D710 0C008BF4 */  jal        ReturnRandomNumber
...
.L8001D7CC:
/* 1E3CC 8001D7CC 0C002498 */  jal        VOID_FUN_80009260
...
/* 1E444 8001D844 0C008BF4 */  jal        ReturnRandomNumber
...
/* 1E458 8001D858 0C008BF4 */  jal        ReturnRandomNumber
