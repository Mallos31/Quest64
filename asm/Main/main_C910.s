...
/* C920 8000BD20 3C138008 */  lui        $s3, %hi(unk_copiedToMapFlags)
/* C924 8000BD24 26734F18 */  addiu      $s3, $s3, %lo(unk_copiedToMapFlags)
...
/* C990 8000BD90 3C018008 */  lui        $at, %hi(saveMap_)
/* C994 8000BD94 3C088008 */  lui        $t0, %hi(LastExitID)
/* C998 8000BD98 14600046 */  bnez       $v1, .L8000BEB4
/* C99C 8000BD9C 00000000 */   nop
/* C9A0 8000BDA0 AC224EF8 */  sw         $v0, %lo(saveMap_)($at)
/* C9A4 8000BDA4 3C018008 */  lui        $at, %hi(saveSubmap_)
/* C9A8 8000BDA8 8D085370 */  lw         $t0, %lo(LastExitID)($t0)
/* C9AC 8000BDAC AC234EFC */  sw         $v1, %lo(saveSubmap_)($at)
/* C9B0 8000BDB0 3C018008 */  lui        $at, %hi(saveExit_)
/* C9B4 8000BDB4 1000003F */  b          .L8000BEB4
/* C9B8 8000BDB8 AC284F00 */   sw        $t0, %lo(saveExit_)($at)
.L8000BDBC:
...
/* C9D0 8000BDD0 3C018008 */  lui        $at, %hi(saveMap_)
/* C9D4 8000BDD4 AC224EF8 */  sw         $v0, %lo(saveMap_)($at)
/* C9D8 8000BDD8 3C018008 */  lui        $at, %hi(saveSubmap_)
/* C9DC 8000BDDC 3C0A8008 */  lui        $t2, %hi(LastExitID)
/* C9E0 8000BDE0 8D4A5370 */  lw         $t2, %lo(LastExitID)($t2)
/* C9E4 8000BDE4 AC294EFC */  sw         $t1, %lo(saveSubmap_)($at)
/* C9E8 8000BDE8 3C018008 */  lui        $at, %hi(saveExit_)
/* C9EC 8000BDEC 10000031 */  b          .L8000BEB4
/* C9F0 8000BDF0 AC2A4F00 */   sw        $t2, %lo(saveExit_)($at)
.L8000BDF4:
...
/* CA30 8000BE30 3C018008 */  lui        $at, %hi(saveSubmap_)
/* CA34 8000BE34 8F395370 */  lw         $t9, 0x5370($t9)
/* CA38 8000BE38 AC384EFC */  sw         $t8, %lo(saveSubmap_)($at)
/* CA3C 8000BE3C 3C018008 */  lui        $at, %hi(saveExit_)
/* CA40 8000BE40 1000001C */  b          .L8000BEB4
/* CA44 8000BE44 AC394F00 */   sw        $t9, %lo(saveExit_)($at)
.L8000BE48:
...
.L8000BEB4:
/* CAB4 8000BEB4 3C128008 */  lui        $s2, %hi(mapFlags_)
/* CAB8 8000BEB8 2401FFFF */  addiu      $at, $zero, -1
/* CABC 8000BEBC 14810018 */  bne        $a0, $at, .L8000BF20
/* CAC0 8000BEC0 26524EE0 */   addiu     $s2, $s2, %lo(mapFlags_)
...
/* CAD4 8000BED4 3C058010 */  lui        $a1, %hi(virt_actorSpace)
/* CAD8 8000BED8 24A50000 */  addiu      $a1, $a1, %lo(virt_actorSpace)
...
/* CB60 8000BF60 3C058011 */  lui        $a1, %hi(virt_GenericTownData)
/* CB64 8000BF64 24A5FE00 */  addiu      $a1, $a1, %lo(virt_GenericTownData)
...
/* CE80 8000C280 0C008BF4 */  jal        ReturnRandomNumber
...
/* CEA8 8000C2A8 0C008BF4 */  jal        ReturnRandomNumber
...
/* CFF0 8000C3F0 0C0036C4 */  jal        VOID_FUN_8000db10
/* CFF4 8000C3F4 AC292908 */   sw        $t1, %lo(D_80082908)($at)
/* CFF8 8000C3F8 0C0038F1 */  jal        VOID_FUN_8000e3c4
...
.L8000C7EC:
/* D3EC 8000C7EC 3C158008 */  lui        $s5, %hi(UNK_DisplayListCommand)
/* D3F0 8000C7F0 3C1E8008 */  lui        $fp, %hi(D_80084F34)
/* D3F4 8000C7F4 27DE4F34 */  addiu      $fp, $fp, %lo(D_80084F34)
/* D3F8 8000C7F8 26B5B2FC */  addiu      $s5, $s5, %lo(UNK_DisplayListCommand)
...
/* D94C 8000CD4C 0C003ACC */  jal        VOID_FUN_8000eb30
/* D950 8000CD50 AC202908 */   sw        $zero, %lo(D_80082908)($at)
/* D954 8000CD54 0C003B76 */  jal        VOID_FUN_8000edd8
...
/* D980 8000CD80 0C009943 */  jal        VOID_FUN_8002650c
...
.L8000CE18:
/* DA18 8000CE18 0C009943 */  jal        VOID_FUN_8002650c
...
/* DADC 8000CEDC 3C108008 */  lui        $s0, %hi(UNK_DisplayListCommand)
/* DAE0 8000CEE0 2610B2FC */  addiu      $s0, $s0, %lo(UNK_DisplayListCommand)
...
.L8000CF74:
/* DB74 8000CF74 3C108008 */  lui        $s0, %hi(UNK_DisplayListCommand)
/* DB78 8000CF78 1260003C */  beqz       $s3, .L8000D06C
/* DB7C 8000CF7C 2610B2FC */   addiu     $s0, $s0, %lo(UNK_DisplayListCommand)
...
/* E630 8000DA30 3C038008 */  lui        $v1, %hi(UNK_DisplayListCommand)
/* E634 8000DA34 3C088008 */  lui        $t0, %hi(D_8007B2F8)
/* E638 8000DA38 2508B2F8 */  addiu      $t0, $t0, %lo(D_8007B2F8)
/* E63C 8000DA3C 2463B2FC */  addiu      $v1, $v1, %lo(UNK_DisplayListCommand)
...
/* EA04 8000DE04 3C0E8008 */  lui        $t6, %hi(unk_copiedToMapFlags)
/* EA08 8000DE08 8DCE4F18 */  lw         $t6, %lo(unk_copiedToMapFlags)($t6)
...
/* EA58 8000DE58 3C118008 */  lui        $s1, %hi(UNK_DisplayListCommand)
/* EA5C 8000DE5C 4480E000 */  mtc1       $zero, $f28
/* EA60 8000DE60 2631B2FC */  addiu      $s1, $s1, %lo(UNK_DisplayListCommand)
...
/* EE00 8000E200 0C008BF4 */  jal        ReturnRandomNumber
...
/* EE24 8000E224 3C058008 */  lui        $a1, %hi(UNK_DisplayListCommand)
/* EE28 8000E228 24A5B2FC */  addiu      $a1, $a1, %lo(UNK_DisplayListCommand)
...
/* EF2C 8000E32C 0C008BF4 */  jal        ReturnRandomNumber
...
/* EF50 8000E350 3C058008 */  lui        $a1, %hi(UNK_DisplayListCommand)
/* EF54 8000E354 24A5B2FC */  addiu      $a1, $a1, %lo(UNK_DisplayListCommand)
...
/* F0E8 8000E4E8 0C008BF4 */  jal        ReturnRandomNumber
...
/* F228 8000E628 3C138008 */  lui        $s3, %hi(UNK_DisplayListCommand)
...
/* F238 8000E638 2673B2FC */  addiu      $s3, $s3, %lo(UNK_DisplayListCommand)
...
/* F3F0 8000E7F0 3C118008 */  lui        $s1, %hi(UNK_DisplayListCommand)
...
/* F400 8000E800 2631B2FC */  addiu      $s1, $s1, %lo(UNK_DisplayListCommand)
