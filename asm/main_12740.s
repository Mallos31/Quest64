...
glabel initUnknownBossData
/* 12740 80011B40 3C038008 */  lui        $v1, %hi(unknownBossData)
/* 12744 80011B44 3C028008 */  lui        $v0, %hi(D_800869F8)
/* 12748 80011B48 244269F8 */  addiu      $v0, $v0, %lo(D_800869F8)
/* 1274C 80011B4C 246369D8 */  addiu      $v1, $v1, %lo(unknownBossData)
.L80011B50:
...
/* 12CC0 800120C0 3C068008 */  lui        $a2, %hi(UNK_TextBoxTextTbl)
/* 12CC4 800120C4 24C6C570 */  addiu      $a2, $a2, %lo(UNK_TextBoxTextTbl)
...
/* 12D5C 8001215C 3C018008 */  lui        $at, %hi(currNPCName)
/* 12D60 80012160 A0690000 */  sb         $t1, ($v1)
/* 12D64 80012164 A02AC970 */  sb         $t2, %lo(currNPCName)($at)
...
/* 12D80 80012180 3C188005 */  lui        $t8, %hi(TBL_bitPattern)
/* 12D84 80012184 0004C8C3 */  sra        $t9, $a0, 3
/* 12D88 80012188 3C088008 */  lui        $t0, %hi(unknownBossData)
/* 12D8C 8001218C 01194021 */  addu       $t0, $t0, $t9
/* 12D90 80012190 030FC021 */  addu       $t8, $t8, $t7
/* 12D94 80012194 9318D740 */  lbu        $t8, %lo(TBL_bitPattern)($t8)
/* 12D98 80012198 910869D8 */  lbu        $t0, %lo(unknownBossData)($t0)
...
/* 12DBC 800121BC 3C188008 */  lui        $t8, %hi(unknownBossData)
/* 12DC0 800121C0 271869D8 */  addiu      $t8, $t8, %lo(unknownBossData)
/* 12DC4 800121C4 000478C3 */  sra        $t7, $a0, 3
/* 12DC8 800121C8 30880007 */  andi       $t0, $a0, 7
/* 12DCC 800121CC 3C098005 */  lui        $t1, %hi(TBL_bitPattern)
/* 12DD0 800121D0 01284821 */  addu       $t1, $t1, $t0
/* 12DD4 800121D4 01F81821 */  addu       $v1, $t7, $t8
/* 12DD8 800121D8 90790000 */  lbu        $t9, ($v1)
/* 12DDC 800121DC 9129D740 */  lbu        $t1, %lo(TBL_bitPattern)($t1)
...
/* 13198 80012598 0C008BF4 */  jal        ReturnRandomNumber
...
/* 13270 80012670 3C068008 */  lui        $a2, %hi(UNK_DisplayListCommand)
/* 13274 80012674 00084880 */  sll        $t1, $t0, 2
/* 13278 80012678 254ACBE8 */  addiu      $t2, $t2, -0x3418
/* 1327C 8001267C 24C6B2FC */  addiu      $a2, $a2, %lo(UNK_DisplayListCommand)
...
/* 13310 80012710 3C188005 */  lui        $t8, %hi(TBL_bitPattern)
...
/* 13324 80012724 9318D740 */  lbu        $t8, %lo(TBL_bitPattern)($t8)
...
/* 13444 80012844 3C038008 */  lui        $v1, %hi(unk_copiedToMapFlags)
/* 13448 80012848 000FC043 */  sra        $t8, $t7, 1
/* 1344C 8001284C 33190007 */  andi       $t9, $t8, 7
/* 13450 80012850 ACB90000 */  sw         $t9, ($a1)
/* 13454 80012854 8C634F18 */  lw         $v1, %lo(unk_copiedToMapFlags)($v1)
...
/* 136A8 80012AA8 3C018008 */  lui        $at, %hi(CameraZPos_)
/* 136AC 80012AAC E42A6DE0 */  swc1       $f10, %lo(CameraZPos_)($at)
...
/* 137B0 80012BB0 3C018008 */  lui        $at, %hi(CameraZPos_)
/* 137B4 80012BB4 E4286DE0 */  swc1       $f8, %lo(CameraZPos_)($at)
...
/* 138AC 80012CAC 3C0C8009 */  lui        $t4, %hi(ButtonPressedFrame)
...
/* 138C0 80012CC0 958C2876 */  lhu        $t4, %lo(ButtonPressedFrame)($t4)
...
/* 13974 80012D74 3C018008 */  lui        $at, %hi(CameraZPos_)
/* 13978 80012D78 C4246DE0 */  lwc1       $f4, %lo(CameraZPos_)($at)
...
.L80012EEC:
/* 13AEC 80012EEC 3C038008 */  lui        $v1, %hi(UNK_DisplayListCommand)
/* 13AF0 80012EF0 3C0A0200 */  lui        $t2, 0x200
/* 13AF4 80012EF4 254A0000 */  addiu      $t2, $t2, 0
/* 13AF8 80012EF8 2463B2FC */  addiu      $v1, $v1, %lo(UNK_DisplayListCommand)
...
/* 13C18 80013018 0C004F4C */  jal        VOID_EMPTY_FUN
...
/* 142B0 800136B0 0C004F4C */  jal        VOID_EMPTY_FUN
...
/* 151AC 800145AC 3C018008 */  lui        $at, %hi(BrianZRotation)
/* 151B0 800145B0 C426BADC */  lwc1       $f6, %lo(BrianZRotation)($at)
