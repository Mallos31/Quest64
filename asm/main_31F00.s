...
/* 31F1C 8003131C A4202878 */  sh         $zero, %lo(NORButtonPresses)($at)
...
/* 31F6C 8003136C 3C048009 */  lui        $a0, %hi(messageQueue)
/* 31F70 80031370 24842880 */  addiu      $a0, $a0, %lo(messageQueue)
...
/* 31F84 80031384 3C058009 */  lui        $a1, %hi(messageQueue)
/* 31F88 80031388 24A52880 */  addiu      $a1, $a1, %lo(messageQueue)
...
/* 320D4 800314D4 3C048009 */  lui        $a0, %hi(messageQueue)
/* 320D8 800314D8 0C00EB04 */  jal        osContStartReadData
/* 320DC 800314DC 24842880 */   addiu     $a0, $a0, %lo(messageQueue)
/* 320E0 800314E0 3C048009 */  lui        $a0, %hi(messageQueue)
/* 320E4 800314E4 24842880 */  addiu      $a0, $a0, %lo(messageQueue)
...
/* 32128 80031528 3C018009 */  lui        $at, %hi(ButtonBeingPressed_MAIN)
/* 3212C 8003152C 3C058009 */  lui        $a1, %hi(NORButtonPresses)
/* 32130 80031530 A4232874 */  sh         $v1, %lo(ButtonBeingPressed_MAIN)($at)
/* 32134 80031534 80590002 */  lb         $t9, 2($v0)
/* 32138 80031538 3C018009 */  lui        $at, %hi(JoystickX)
/* 3213C 8003153C 24A52878 */  addiu      $a1, $a1, %lo(NORButtonPresses)
...
/* 32158 80031558 3C018009 */  lui        $at, %hi(ButtonPressedFrame)
/* 3215C 8003155C 00695024 */  and        $t2, $v1, $t1
/* 32160 80031560 A42A2876 */  sh         $t2, %lo(ButtonPressedFrame)($at)
...
/* 32220 80031620 3C178009 */  lui        $s7, %hi(messageQueue)
/* 32224 80031624 254A2898 */  addiu      $t2, $t2, %lo(D_80092898)
/* 32228 80031628 000948C0 */  sll        $t1, $t1, 3
/* 3222C 8003162C 26F72880 */  addiu      $s7, $s7, %lo(messageQueue)
...
/* 32708 80031B08 3C048009 */  lui        $a0, %hi(messageQueue)
/* 3270C 80031B0C 24842880 */  addiu      $a0, $a0, %lo(messageQueue)
...
/* 32724 80031B24 3C048009 */  lui        $a0, %hi(messageQueue)
/* 32728 80031B28 24842880 */  addiu      $a0, $a0, %lo(messageQueue)
...
/* 32754 80031B54 0C00F14C */  jal        __osGetId
...
/* 32788 80031B88 3C048009 */  lui        $a0, %hi(messageQueue)
/* 3278C 80031B8C 24842880 */  addiu      $a0, $a0, %lo(messageQueue)
