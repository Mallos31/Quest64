...
/* C238 8000B638 3C0A8008 */   lui       $t2, %hi(UNK_DisplayListCommand)
/* C23C 8000B63C 852F0074 */  lh         $t7, 0x74($t1)
/* C240 8000B640 3C08803B */  lui        $t0, %hi(D_803AA164)
/* C244 8000B644 254AB2FC */  addiu      $t2, $t2, %lo(UNK_DisplayListCommand)
...
/* C5DC 8000B9DC 3C0F8005 */  lui        $t7, %hi(TBL_bitPattern)
...
/* C5F0 8000B9F0 91EFD740 */  lbu        $t7, %lo(TBL_bitPattern)($t7)
...
/* C664 8000BA64 3C038008 */  lui        $v1, %hi(currNPCName)
/* C668 8000BA68 8C42ABD8 */  lw         $v0, %lo(D_803AABD8)($v0)
/* C66C 8000BA6C 2463C970 */  addiu      $v1, $v1, %lo(currNPCName)
...
/* C694 8000BA94 3C038008 */  lui        $v1, %hi(UNK_TextBoxTextTbl)
/* C698 8000BA98 8C42ABF8 */  lw         $v0, %lo(D_803AABF8)($v0)
/* C69C 8000BA9C 2463C570 */  addiu      $v1, $v1, %lo(UNK_TextBoxTextTbl)
...
/* C788 8000BB88 3C038008 */  lui        $v1, %hi(currNPCName)
/* C78C 8000BB8C 8C42ABD8 */  lw         $v0, %lo(D_803AABD8)($v0)
/* C790 8000BB90 2463C970 */  addiu      $v1, $v1, %lo(currNPCName)
...
/* C7B4 8000BBB4 3C038008 */  lui        $v1, %hi(UNK_TextBoxTextTbl)
/* C7B8 8000BBB8 2442AAB4 */  addiu      $v0, $v0, %lo(MammonDeathText)
/* C7BC 8000BBBC 2463C570 */  addiu      $v1, $v1, %lo(UNK_TextBoxTextTbl)
...
/* C7F4 8000BBF4 0C00B9DA */  jal        UNK_calledWhenWritingToTextbox
...
/* C830 8000BC30 3C018008 */  lui        $at, %hi(fadeType)
/* C834 8000BC34 240F0003 */  addiu      $t7, $zero, 3
/* C838 8000BC38 A42FB2F0 */  sh         $t7, %lo(fadeType)($at)
...
/* C8A4 8000BCA4 3C018008 */  lui        $at, %hi(brianExitAnim)
/* C8A8 8000BCA8 AC2BBA4C */  sw         $t3, %lo(brianExitAnim)($at)
